...
class TravelViewController: UIViewController, CouponsViewDelegate, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        textDriverName.text = "\(Request.shared.driver?.firstName ?? "Not Provided") \(Request.shared.driver?.lastName ?? "")"
        textCarModel.text = "\(Request.shared.driver?.car?.title ?? "Not Provided"), \(Request.shared.driver?.carColor ?? "Not Provided")"
        textPlateNumber.text = Request.shared.driver?.carPlate ?? "Not Provided"
